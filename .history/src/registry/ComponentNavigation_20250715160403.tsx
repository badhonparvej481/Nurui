...
export const navigation = [
  ...
  // buttons
  {
    ...
    title: "Buttons",
    submenu: [
      { name: "Magnet button", href: `${baseUrl}/magnet-button` },
      { name: "Gradient button", href: `${baseUrl}/gradient-button` },
      { name: "Border Animation button", href: `${baseUrl}/border-animation-button` },
      { name: "Hover Shadow button", href: `${baseUrl}/hover-shadow-button` },
      { name: "Text Fall button", href: `${baseUrl}/text-fall-button` },
      { name: "Future button", href: `${baseUrl}/future-button` },
    ],
  },
  // cards
  {
