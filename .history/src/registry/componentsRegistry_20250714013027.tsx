...
import AnimatedGradientBorder from "@/components/nurui/animated-gradient-border.tsx?raw";
...
export const Index: Record<string, ComponentEntry> = {
  ...
  featureCard: {
    ...
    othersCode: [{ fileName: "animation-gradient-border", code: FeatureCardCode }],
  },
  // forms
  contactForm: {
