...
import "@/components/styles/digital-hero.css"; // Import custom styles
...
export default function DigitalHero() {
  ...
  return (
    <section className="flex flex-col justify-center min-h-screen bg-[#121212] relative overflow-hidden">
      {/* Particle canvas */}
      <canvas
        ref={canvasRef}
