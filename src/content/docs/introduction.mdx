---
title: "Introduction"
description: "nurui is a React-based UI component library that empowers developers to build elegant user interfaces faster with reusable components and CLI support."
