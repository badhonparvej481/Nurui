...
export const CenterIcon = (
  <CodeIcon
    className="z-0 text-[var(--secondary-color)] h-20 w-20 animate-float rounded-full bg-[var(--secondary-color-3)] p-4 shadow-lg hover:bg-[var(--secondary-color-2)] border border-[var(--secondary-color)] border-dashed"
    style={{
      boxShadow: "0 0 20px 10px #80eeb433",
    }}
  />
);
      ...
      >
        ...
        {items.map((item, index) => {
          return (
            <div
              key={index}
              className="absolute flex h-14 w-14 items-center justify-center rounded-full bg-white/20 shadow-xl shadow-[#80eeb433] backdrop-blur-md transition-transform duration-500 ease-out"
