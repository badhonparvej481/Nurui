...
export function FeatureBlockAnimatedCard({ className }: { className: string }) {
  return (
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[var(--glass-color-2)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className,
      )}
    >
      {children}
