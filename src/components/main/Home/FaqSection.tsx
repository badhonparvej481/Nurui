...
const FaqSection = () => {
  const roundedButton = (idx: string, category: string) => (
    <button
      key={idx}
      className="bg-[var(--primary-color)] text-[var(--black-color)] font-semibold border border-[var(--primary-color)] cursor-pointer rounded-full px-3.5 py-2.5 capitalize"
    >
      {category}
    </button>
  );
    ...
    <section className="container flex items-center gap-20">
      ...
      <div className="w-1/3 min-h-96 space-y-5">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-5 pt-1">
          {faqsData.map((data, i) =>
            roundedButton(data?.category + i, data?.category)
          )}
        </div>
      </div>
      {/* question and answer */}
      <div className="w-2/3 space-y-5">
        {faqsData?.map((faqData, i) => (
          <QuestionAnswer
            key={i}
            questionNumber={faqData?.questions?.}
...
const data = [
  {
    ...
    answer:
      "Omnichannel communication refers to a multi-channel approach to marketing, selling, and serving customers in a way that provides a seamless and integrated experience across all channels. In the context of customer communication, this means creating a unified and consistent experience for users across various platforms and channels, such as websites, mobile apps, social media, ",
  },
  {
    number: 2,
      ...
      "questions": [
        {
          "number": 1,
          "question": "What is omnichannel communication?",
          "answer": "Omnichannel communication integrates multiple channels for seamless interaction."
        },
        {
          "number": 2,
          "question": "How do I get started with your omnichannel platform?",
          "answer": "You can sign up on our website and follow the onboarding guide."
        },
        {
          "number": 3,
          "question": "Do I need technical skills to use your platform?",
          "answer": "No, our platform is designed for ease of use with a user-friendly interface."
        },
        {
          "number": 4,
      ...
      "questions": [
        {
          "number": 1,
          "question": "Can I integrate your platform with other tools or systems?",
          "answer": "Yes, our platform supports various third-party integrations via API."
        },
        {
          "number": 2,
          "question": "Does your platform support CRM integrations?",
          "answer": "Yes, we support integrations with major CRMs like Salesforce and HubSpot."
        },
        {
          "number": 3,
          "question": "How do I set up API access?",
          "answer": "You can generate API keys from the developer section in your account."
        },
        {
          "number": 4,
        ...
        },
        {
          ...
          "answer": "Our support team is available 24/7 to assist with integration issues."
        }
      ]
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "answer": "Yes, you can tailor messages based on each channel's requirements."
        },
        {
          "number": 3,
        ...
        },
        {
          ...
          "answer": "Yes, our platform provides unified tracking across all channels."
        }
      ]
    },
    {
      ...
      "questions": [
        {
          "number": 1,
          "question": "How does your platform handle customer support?",
          "answer": "We offer automated responses, ticketing, and live chat support."
        },
        {
          "number": 2,
        ...
        },
        {
          ...
          "answer": "Yes, you can collect and analyze customer feedback through surveys."
        },
        {
          "number": 4,
        ...
        },
        {
          ...
          "answer": "Yes, our platform provides detailed analytics for customer interactions."
        }
      ]
    },
    {
      ...
      "questions": [
        {
          "number": 1,
          "question": "What types of businesses can benefit from omnichannel communication?",
          "answer": "E-commerce, SaaS, healthcare, and customer service industries benefit the most."
        },
        {
          "number": 2,
          "question": "How does omnichannel improve customer engagement?",
          "answer": "It ensures seamless communication across multiple touchpoints."
        },
        {
          "number": 3,
          "question": "Can omnichannel help increase sales?",
          "answer": "Yes, businesses see higher conversion rates with consistent communication."
        },
        {
          "number": 4,
          "question": "What is the ROI of using omnichannel communication?",
          "answer": "Companies experience improved customer retention and satisfaction."
        },
        {
          "number": 5,
          "question": "Is omnichannel communication suitable for small businesses?",
          "answer": "Yes, even small businesses can leverage omnichannel strategies for growth."
        }
      ]
    }
  ]
