...
const NewsLetter = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto -mt-36  bg-[var(--glass-color)] py-8 rounded-lg flex flex-col items-center justify-center text-center gap-3.5">
      <h6 className="text-3xl font-semibold">Subscribe to our newsletter</h6>
      <p className="max-w-lg">
        Get the latest news and updates from us by subscribing to our newsletter
        today. We promise not to spam you.
      </p>
      <div className="mx-auto w-full max-w-lg mt-2">
        <div className="relative z-10 flex w-full cursor-pointer items-center overflow-hidden rounded-xl border border-[var(--border-color)] p-[1.5px]">
          ...
          <div className="relative z-20 flex w-full rounded-[0.60rem] bg-[var(--background-color)] p-2">
            <input
              onFocus={() => setPlaceholder("We won't spam you!")}
              onBlur={() => setPlaceholder("subscribe to our newsletter")}
              type="text"
