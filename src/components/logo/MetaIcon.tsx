    ...
    >
      ...
      >
        ...
        >
          <stop
            offset="0%"
            style={{ stopColor: "rgb(0,100,225)", stopOpacity: 1 }}
          />
          <stop
            offset="40%"
            style={{ stopColor: "rgb(0,100,225)", stopOpacity: 1 }}
        ...
        >
          ...
          <stop
            offset="100%"
            style={{ stopColor: "rgb(0,100,224)", stopOpacity: 1 }}
          />
        </linearGradient>
        <path
          d="M 7.818 38.898 c -1.165 0 -2.154 0.817 -2.982 2.068 c -1.171 1.767 -1.887 4.398 -1.887 6.926 c 0 1.042 0.229 1.843 0.528 2.327 l -2.514 1.656 C 0.317 50.801 0 49.392 0 47.786 c 0 -2.919 0.801 -5.962 2.325 -8.312 c 1.352 -2.084 3.303 -3.541 5.541 -3.541 L 7.818 38.898 z"
          style={{
            stroke: "none",
            strokeWidth: 1,
            strokeDasharray: "none",
